...
// controls (k10input) and a paired Bluetooth controller (k10blehid).
namespace k10menu {
...
enum ControlMode { MODE_LOCAL, MODE_BT_HID, MODE_MATRIX, MODE_ADKEYBOARD };
...
//   read       : NES-pad source used to navigate (local k10input or BLE HID).
